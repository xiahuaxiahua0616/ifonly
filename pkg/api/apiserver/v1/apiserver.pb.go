...
const file_apiserver_v1_apiserver_proto_rawDesc = "" +
	"\n" +
	"\x1capiserver/v1/apiserver.proto\x12\x02v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1aapiserver/v1/healthz.proto\x1a\x17apiserver/v1/post.proto\x1a\x17apiserver/v1/user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\x9e\x0e\n" +
	"\x06ifonly\x12v\n" +
	...
	"\f博客管理\x12\x12列出所有文章*\bListPost\x82\xd3\xe4\x93\x02\v\x12\t/v1/postsB\xa8\x02\x92A\xe8\x01\x12\xbe\x01\n" +
	"\n" +
	"ifonly API\"\\\n" +
	"\x18小而美的博客项目\x12*https://github.com/xiahuaxiahua0616/ifonly\x1a\x14colin404@foxmail.com*M\n" +
	"\vMIT License\x12>https://github.com/xiahuaxiahua0616/ifonly/blob/master/LICENSE2\x031.0*\x01\x022\x10application/json:\x10application/jsonZ:github.com/xiahuaxiahua0616/ifonly/pkg/api/apiserver/v1;v1b\x06proto3"
...
var file_apiserver_v1_apiserver_proto_depIdxs = []int32{
	0,  // 0: v1.ifonly.Healthz:input_type -> google.protobuf.Empty
	1,  // 1: v1.ifonly.Login:input_type -> v1.LoginRequest
	2,  // 2: v1.ifonly.RefreshToken:input_type -> v1.RefreshTokenRequest
	3,  // 3: v1.ifonly.ChangePassword:input_type -> v1.ChangePasswordRequest
	4,  // 4: v1.ifonly.CreateUser:input_type -> v1.CreateUserRequest
	5,  // 5: v1.ifonly.UpdateUser:input_type -> v1.UpdateUserRequest
	6,  // 6: v1.ifonly.DeleteUser:input_type -> v1.DeleteUserRequest
	7,  // 7: v1.ifonly.GetUser:input_type -> v1.GetUserRequest
	8,  // 8: v1.ifonly.ListUser:input_type -> v1.ListUserRequest
	9,  // 9: v1.ifonly.CreatePost:input_type -> v1.CreatePostRequest
	10, // 10: v1.ifonly.UpdatePost:input_type -> v1.UpdatePostRequest
	11, // 11: v1.ifonly.DeletePost:input_type -> v1.DeletePostRequest
	12, // 12: v1.ifonly.GetPost:input_type -> v1.GetPostRequest
	13, // 13: v1.ifonly.ListPost:input_type -> v1.ListPostRequest
	14, // 14: v1.ifonly.Healthz:output_type -> v1.HealthzResponse
	15, // 15: v1.ifonly.Login:output_type -> v1.LoginResponse
	16, // 16: v1.ifonly.RefreshToken:output_type -> v1.RefreshTokenResponse
	17, // 17: v1.ifonly.ChangePassword:output_type -> v1.ChangePasswordResponse
	18, // 18: v1.ifonly.CreateUser:output_type -> v1.CreateUserResponse
	19, // 19: v1.ifonly.UpdateUser:output_type -> v1.UpdateUserResponse
	20, // 20: v1.ifonly.DeleteUser:output_type -> v1.DeleteUserResponse
	21, // 21: v1.ifonly.GetUser:output_type -> v1.GetUserResponse
	22, // 22: v1.ifonly.ListUser:output_type -> v1.ListUserResponse
	23, // 23: v1.ifonly.CreatePost:output_type -> v1.CreatePostResponse
	24, // 24: v1.ifonly.UpdatePost:output_type -> v1.UpdatePostResponse
	25, // 25: v1.ifonly.DeletePost:output_type -> v1.DeletePostResponse
	26, // 26: v1.ifonly.GetPost:output_type -> v1.GetPostResponse
	27, // 27: v1.ifonly.ListPost:output_type -> v1.ListPostResponse
